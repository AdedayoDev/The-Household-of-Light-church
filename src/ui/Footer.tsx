  ...
  return (
    <footer className="w-full bg-primary">
      ...
      <div className="w-11/12 md:w-10/12 mx-auto relative">
        <div
          className="bg-[#FADEFF] flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-20 py-8 rounded-2xl absolute left-1/2 -translate-x-1/2 -top-40 md:-top-48 w-[90%] md:w-[85%] lg:w-[90%] shadow-xl gap-8"
        >
          ...
          <div className="w-full lg:w-auto flex justify-center lg:justify-end">
            <img src="donate.svg" alt="donate" className="w-40 h-40 md:w-auto md:h-auto" />
          </div>
        </div>
      ...
      <div className="border-b border-white py-12">
        <div className="w-11/12 md:w-10/12 mx-auto flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-4">
          ...
          <div className="text-white/80 font-semibold text-base md:text-xl w-full lg:w-5/12 space-y-4">
            <img src="logo-on-footer.svg" alt="church logo" className="w-24 md:w-32" />
          ...
          <div className="text-white flex flex-col gap-4 text-sm md:text-base w-full sm:w-auto">
            ...
            <NavLink to="/about-us" className="capitalize hover:text-primary transition">
              About us
            </NavLink>
            <NavLink to="/sermons" className="capitalize hover:text-primary transition">
              sermons
            </NavLink>
            <NavLink to="/partner" className="capitalize hover:text-primary transition">
              give
            </NavLink>
          </div>
          ...
          {/* Service times */}
          <div className="text-white flex flex-col gap-4 text-sm md:text-base w-full sm:w-auto">
            <h2 className="capitalize text-white/80 font-semibold">service times</h2>
            <p>Sundays: 9am</p>
            <p>Tuesdays: 5pm</p>
            <p>Firdays: 5pm</p>
          </div>
      ...
      <div className="w-11/12 md:w-10/12 mx-auto flex flex-col sm:flex-row py-8 items-center justify-between gap-4 text-center sm:text-left">
        ...
        <div className="flex items-center justify-center gap-6">
          <NavLink to="" className="text-2xl md:text-4xl text-white hover:text-primary/80 transition">
            <FaYoutube />
          </NavLink>
          <NavLink to="" className="text-2xl md:text-4xl text-white hover:text-primary/80 transition">
            <FaFacebook />
