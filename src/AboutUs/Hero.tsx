  ...
  return (
    <section className='relative w-full min-h-screen flex items-center justify-center overflow-hidden pt-20'>
      ...
      >
        ...
        >
          We are devoted to raising men by God's Word and His Spirit. Through
          sound teaching, genuine discipleship, and the Spirit's transforming
          power, we help believers grow in faith, character, and
